...
def get_label(task, line):
    if task in ["MNLI", "MRPC", "QNLI", "QQP", "RTE", "SNLI", "SST-2", "STS-B", "WNLI", "CoLA", "amazon-review-en", "amazon-review-de", "amazon-review-es", "amazon-review-fr", 'amazon-review-ja', 'amazon-review-zh']:
        if not task.startswith("amazon-review"):
        ...
        if task == 'CoLA':
            ...
            return line[-1]
        elif task.startswith("amazon-review"):
            return line[2]
        else:
...
def main():
    ...
    parser.add_argument("--task", type=str, nargs="+", 
        default=['amazon-review-de', 'amazon-review-en', 'amazon-review-es', 'amazon-review-fr', 'amazon-review-ja', 'amazon-review-zh'],
        help="Task names")
    ...
    for seed in args.seed:
        ...
        for task, dataset in datasets.items():
            ...
            for label in label_list.keys():
                print(f"{label}: {len(label_list[label])}")
